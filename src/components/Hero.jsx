  ...
  return (
    ...
    >
        ...
        >
          <div>
            ...
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
              ...
              <a href="Ruwina-Ranasinghe.pdf" download="RuwinaRanasinghe-Resume.pdf">
      ...
      <div className="absolute bottom-1 left-0 w-full flex justify-center items-center">
        ...
        >
          <a href="#about">
            <div className="w-[23px] h-[42px] sm:w-[35px] sm:h-[64px] rounded-3xl border-4 border-secondary flex justify-center items-start p-1 sm:p-2">
              <motion.div
                animate={{ y: [0, 20, 0] }}
                transition={{
                  duration: 1.5,
